...
$sqlNr='SELECT * FROM soferi where NrColoana=2';



 $qrs = mysqli_query(  $conn,$sqlNr );
 $NrS2=mysqli_num_rows($qrs);

?>

   <div class="col-sm-10">
   	<h1 class="text-center">Administrare Soferi coloana 2 <span style="color:red">(<?php echo $NrS2?> soferi)</span></h1>
...
$sqlCount='SELECT * FROM soferi where NrColoana=2';
$Nr=0; 
$SoferiPagina=10;
...
$sql="SELECT * FROM soferi where NrColoana=2 order by Nume limit $Start,$SoferiPagina ";	
...
<div class="text-center">
 	 	<nav>
			<ul class="pagination pagination-lg">
				...
				if($Pagina>1) {
				?>
				<li><a href="AdminCol2.php?Pagina=<?php echo $Pagina-1;?>">&laquo;</a></li>
<?php } } ?>
		<?php
		...
		?>
			...
			<li class="active"><a href="AdminCol2.php?Pagina=<?php echo $i;?>"><?php echo $i;?></a></li>
<?php }
	else{
?>
			    <li><a href="AdminCol2.php?Pagina=<?php echo $i;?>"><?php echo $i;?></a></li>
	<?php }
	 }
     }
	...
	<?php
				...
				if($Pagina< $S) {
				?>
				<li><a href="AdminCol2.php?Pagina=<?php echo $Pagina+1;?>">&raquo;</a></li>
<?php } } ?>
