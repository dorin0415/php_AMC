        <?php require_once("Include/HeaderAlerteSoferi.php");?>
      		...
      		<h3 class="subtitlu">Alerte atestat DE coloana administrativa</h3>	

<?php


   $sqlSelect='SELECT Nume,DataExpAtestatDE FROM soferi where NrColoana=6 order by DataExpAtestatDE desc';
