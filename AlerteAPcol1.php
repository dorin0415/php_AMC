  <?php require_once("Include/HeaderAlerteSoferi.php");?>
      	...
      	<h3 class="subtitlu">Alerte aviz psihologic coloana 1</h3>	

<?php
$sqlSelect='SELECT Nume,DataExpAvizPsiho FROM soferi where NrColoana=1 order by DataExpAvizPsiho desc';
