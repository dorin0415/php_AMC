  <?php require_once("Include/HeaderAlerteSoferi.php");?>
      	...
      	<h3 class="subtitlu">Alerte aviz psihologic coloana 5</h3>	

<?php
$sqlSelect='SELECT Nume,DataExpAvizPsiho FROM soferi where NrColoana=5 order by DataExpAvizPsiho desc';
