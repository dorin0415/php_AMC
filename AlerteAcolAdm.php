        <?php require_once("Include/HeaderAlerteSoferi.php");?>
      		...
      		<h3 class="subtitlu">Alerte atestat CE coloana administrativa</h3>	

<?php


   $sqlSelect='SELECT Nume,DataExpAtestat FROM soferi where NrColoana=6 order by DataExpAtestat desc';
