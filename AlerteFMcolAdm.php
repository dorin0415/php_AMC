  <?php require_once("Include/HeaderAlerteSoferi.php");?>
      	...
      	<h3 class="subtitlu">Alerte fisa medicala coloana administrativa</h3>	

<?php
$sqlSelect='SELECT Nume,DataExpFisaMed FROM soferi where NrColoana=6 order by DataExpFisaMed desc';
