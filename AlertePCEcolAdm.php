  ...
  <h3 class="subtitlu">Alerte permis CE coloana administrativa</h3>	

<?php
$sqlSelect='SELECT Nume,DataExpPermisCE FROM soferi where NrColoana=6 order by DataExpPermisCE desc';
