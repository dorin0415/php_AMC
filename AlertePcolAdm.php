  ...
  <h3 class="subtitlu">Alerte permis BE coloana administrativa</h3>	

<?php
$sqlSelect='SELECT Nume,DataExpPermis FROM soferi where NrColoana=6 order by DataExpPermis desc';
