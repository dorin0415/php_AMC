...
if(isset($_POST["submit"])){
     ...
     if(empty($Nume)){
      ...
      $Edit=$_GET['Edit'];	
     $sql="UPDATE soferi set Nume='$Nume',DataExpAtestat='$DataA' where IdSofer='$Edit'";
...
?>
	...
	<form action="EditareSoferA.php?Edit=<?php echo $SoferId?>" method="post" enctype="multipart/form-data">
				<fieldset>
