...
if(isset($_POST["submit"])){
     ...
     if(empty($Nume)){
      ...
      $Edit=$_GET['Edit'];	
     $sql="UPDATE soferi set Nume='$Nume',DataExpPermis='$DataP' where IdSofer='$Edit'";
...
?>
	...
	<form action="EditareSoferP.php?Edit=<?php echo $SoferId?>" method="post" enctype="multipart/form-data">
				<fieldset>
