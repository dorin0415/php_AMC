...
if(isset($_POST["submit"])){
     ...
     if(empty($Nume)){
      ...
      $Edit=$_GET['Edit'];	
     $sql="UPDATE soferi set Nume='$Nume',DataExpPermisCE='$DataP' where IdSofer='$Edit'";
...
?>
	...
	<form action="EditareSoferPCE.php?Edit=<?php echo $SoferId?>" method="post" enctype="multipart/form-data">
				<fieldset>
