...
<div class="row">
	...
	<ul id="SideMenu" class="nav nav-pills nav-stacked">           
           ...
           <li class="dropdown">
          <a href="#" class="dropdown-toggle link" data-toggle="dropdown">Personal</a>
          <ul class="dropdown-menu" style="width: 100%">
           ...
           <li class="dropdown">
          <a href="#" class="dropdown-toggle link" data-toggle="dropdown">Soferi</a>
          <ul class="dropdown-menu" style="width: 100%">
         ...
         <li class="dropdown">
          <a href="#" class="dropdown-toggle link" data-toggle="dropdown">Autovehicule</a>
          <ul class="dropdown-menu" style="width: 100%">
        ...
        <li><a href="Logout.php">
            <span class="glyphicon glyphicon-plus" onclick="return confirm('Confirmati deconectarea?')"></span>    
            &nbsp;Logout</a></li>
